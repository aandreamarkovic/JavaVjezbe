...
class Auto {
	 ...
	 * format("Auto [markaAuta=%s, godisteAuta=%d, snagaMotora=%.1f, prodato=%s, kubikazaMotora=%.1f, registrovan=%.2f, cijenaReg=%2.f]"
	 * ,markaAuta , godisteAuta, snagaMotora, prodato? "da" : "ne",kubikazaMotora,
